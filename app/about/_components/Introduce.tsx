...
import ExpertiseSection from "./Skills";
  ...
  return (
    <section className="py-10 h-full flex items-center justify-center overflow-hidden">
      <motion.div
        ...
        className="container mx-auto px-4 grid grid-cols-1 2xl:grid-cols-2 md:gap-12 items-center"
      >
        <div className="order-2 lg:order-1 flex flex-col text-center lg:text-left ">
          <div className="flex flex-col gap-1 md:gap-2">
            <div className="space-y-0">
              <p className="text-primary font-light tracking-[0.4em] uppercase text-2xl md:text-sm opacity-80">
                Nice to  Meet you!
              </p>

            </div>

            <h1 className="flex flex-col mt-4 md:mt-6 gap-2">
              <span className=" text-4xl md:text-6xl  font-black tracking-tighter text-white leading-[0.8]">
                WELCOME TO MY
              </span>

              <span className="relative inline-block text-4xl md:text-7xl font-black uppercase leading-[0.9] tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500">
                Creative  World
              </span>
            </h1>
            ...
            >
              <h2 className="text-3xl  font-bold leading-tight flex gap-4">

                <Quote className="text-blue-400 rotate-180 size-5 md:size-10" />

                <span className="">
                  {slogan || "Crafting digital experiences with design, editing, and marketing expertise."}
                </span>
